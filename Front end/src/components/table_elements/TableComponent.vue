<template>
    <div class="container table-responsive text-center">
        <table class="table table-sm align-middle" style="width: 950px; margin: auto;">
            <thead>
                <tr style="border: none;">
                    <th v-for="filter in filters" style="border: none;">
                        <component :is="filter.component" v-bind="filter.props" :ref="filter.reference" @filterChanged="$emit('filterChanged')"></component>
                    </th>
                </tr>
            ...
            <tbody>
                <tr v-for="row in rows" :key="row">
                    <td v-for="data in row">
                        ...
                        <component v-if="typeof data === 'object' && data.component" :is="data.component" v-bind="data.props"></component>
